            ...
            <div className="p-8 rounded-[32px] bg-slate-50/80 border border-slate-200/80 shadow-sm space-y-6">
              ...
              <div className="p-4 rounded-2xl bg-blue-50/80 border border-blue-200/80 flex items-center justify-between">
                <div>
                  ...
                  <div className="text-[11px] text-slate-500">PDF &amp; interactive preview</div>
                </div>
                <button
                  onClick={onOpenResume}
                  className="px-4 py-2 rounded-full bg-blue-600 text-white text-xs font-bold shadow-md hover:bg-blue-700 transition-colors"
                >
                  View CV
                </button>
              </div>
